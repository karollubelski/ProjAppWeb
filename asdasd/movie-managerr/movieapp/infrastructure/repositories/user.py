...
from movieapp.infrastructure.utils.password import hash_password
from movieapp.core.domain.user import User, UserIn
from movieapp.core.repositories.iuser import IUserRepository
from movieapp.db import database, user_table
...
class UserRepository(IUserRepository):
    ...
    async def register_user(self, user: UserIn) -> Any | None:
        ...
        if await self.get_by_name(user.name):
            return None

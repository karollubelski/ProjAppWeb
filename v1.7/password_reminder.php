<!-- mail: tmail4230@gmail.com
haslo do apki: fzgy vnmv zofq nfoo -->
<?php
...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            height: 100vh;
            background-color: #282c34; /* Ciemny granatowy kolor tła */
            margin: 0;
        ...
        .reset-container {
            ...
            max-width: 400px;
            padding: 2rem;
            background-color: #2c3e50; /* Ciemniejszy odcień dla formularza */
            border-radius: 8px;
            box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);
            color: white; /* Tekst na biały, aby był czytelny */
        }
        .reset-header {
            text-align: center;
        ...
        .form-control {
            border-color: #34495e; /* Ciemniejsza ramka dla inputów */
            background-color: #34495e; /* Tło inputów */
            color: white; /* Kolor tekstu na biały */
        }
        .btn-primary {
            width: 100%;
            background-color: #1abc9c; /* Kolor przycisku */
            border: none;
            padding: 0.75rem;
            transition: background-color 0.3s ease;
        }
        .btn-primary:hover {
            background-color: #16a085; /* Ciemniejszy odcień przycisku na hover */
        }
    </style>
</head>
<body>
